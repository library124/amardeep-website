                  ...
                  {workshop.is_paid ? (
                    <PaymentButton
                      ...
                      onPaymentSuccess={(result) => {
                        alert(result.message || 'Workshop registration successful!');
                        fetchUpcomingWorkshops(); // Refresh workshops
                      }}
                    ...
                    <button
                      ...
                      className={`w-full py-3 px-4 rounded-lg font-semibold text-sm transition-colors ${
                        workshop.is_full
                          ...
                          : 'bg-gradient-to-r from-green-600 to-emerald-600 text-white hover:from-green-700 hover:to-emerald-700 transform hover:scale-105 transition-transform'
                      }`}
                    >
                      {workshop.is_full ? (
                        <>
